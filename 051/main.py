...
class InternetSpeedTwiterBot:
    ...
    def get_internet_speed(self):
        ...
        go_button.click()
        sleep(40)
        down_txt = self.driver.find_element(
            By.XPATH,
        ...
        up_txt = self.driver.find_element(
            By.XPATH,
    ...
    def tweet_at_provider(self):
        ...
        print(
            f"You contracted {PROMISSE_DOWN} Mbps of Download, but they're providing only {internet_speed.down} Mbps"
        )
